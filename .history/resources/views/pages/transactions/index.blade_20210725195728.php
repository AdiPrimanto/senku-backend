                                    ...
                                    @forelse ($items as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @endif --}}
                                                <a href="#myModal" data-remote="{{ route('transactions.show', $item->id) }}" data-toggle="modal" data-target="#mymodal" data-title="Detail Transaksi {{ $item->uuid}}" class="btn btn-info"><i class="fa fa-eye"></i></a>
