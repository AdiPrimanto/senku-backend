        ...
        <div class="card-body card-block">
            <form action="{{ route('transactions.update', $item->id) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="email" value="{{ old('email') ? odl('email') : $item->email }}" class="form-control @error('email') is-invalid @enderror" />
                    @error('email') <div class="text-muted">{{ $message }}</div> @enderror
                </div>
                <div class="form-group">
                    <label for="price" class="form-control-label">Harga Barang</label>
                    <input type="number" name="price" value="{{ old('price') ? odl('price') : $item->price }}" class="form-control @error('price') is-invalid @enderror" />
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="ckeditor form-control @error('description') is-invalid @enderror">{{ old('description') ? odl('description') : $item->description }}</textarea>
