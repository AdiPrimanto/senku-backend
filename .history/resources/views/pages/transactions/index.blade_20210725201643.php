                                    ...
                                    @forelse ($items as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-primary" data-remote="{{ route('transactions.show', $item->id) }}" data-toggle="modal" data-target="#myModal" data-title="Detail Transaksi {{ $item->uuid}}">
                                                    Launch demo modal
                                                </button>
