        ...
        <div class="card-body card-block">
            <form action="{{ route('product-galleries.store') }}" method="post" enctype="multipart/form-data">
                ...
                {{-- <div class="form-check">
                    <label for="is_default" class="form-control-label">Jadikan Default Barang</label>
                    <br>
                    <label>
                ...
                <div class="form-check">
                    <input class="form-check-input @error('is_default') is-invalid @enderror" type="radio" name="is_default" value="0" checked>
                    <label class="form-check-label" for="is_default">
                        Tidak
                    </label>
                </div>
